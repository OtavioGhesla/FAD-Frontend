...
export default{
  ...
  methods: {
    async submitForm() {
        if (!this.service || !this.baseImage) {
            this.errorService = !this.service ? 'Por favor escolha um nome para o serviço' : '';
            this.errorImage = !this.baseImage ? 'Por favor escolha uma imagem base' : '';
            return;
        }
